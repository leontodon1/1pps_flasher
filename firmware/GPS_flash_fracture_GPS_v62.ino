// 01.03.2026, Dr. Björn Kattentidt
// Arduino NANO
...
// 260301 v62: Piezo buzzer sounds slowly when NMEA data is not valid und quickly when the battery is low
...
// timing variables
const unsigned long ONdurLight = 600;       // SET: default long flash duration for illumination control
...
void setup() {
  ...
  // Prescaler erlaubt: 1, 8, 32, 64, 128, 256, 1024
  // TCCR2B |= (1 << CS21) | (1 << CS20);                                       // CS22=0, CS21=1, CS20=1, Prescaler 32
  // TCCR2B = (TCCR2B & 0b11111000) | (1 << CS22);                              // CS22=1, CS21=0, CS20=0, Prescaler 64
  // TCCR2B = (TCCR2B & 0b11111000) | (1 << CS22) | (1 << CS20);                // CS22=1, CS21=0, CS20=1, Prescaler 128
  // TCCR2B = (TCCR2B & 0b11111000) | (1 << CS22) | (1 << CS21);                // CS22=1, CS21=1, CS20=0, Prescaler 256
  TCCR2B = (TCCR2B & 0b11111000) | (1 << CS22) | (1 << CS21) | (1 << CS20);  // CS22=1, CS21=1, CS20=1, Prescaler 1024

  OCR2A = 18;  // Scaler: 16MHz/(2*prescaler*fPiezo)-1

  // Interrupt noch NICHT aktivieren
  sei();
...
ISR(TIMER2_COMPA_vect) {
  state = !state;
  digitalWrite(piezoPin1, state);
  digitalWrite(piezoPin2, !state);
}
